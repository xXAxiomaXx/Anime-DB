...
function Upcoming({ rendered }) {
  ...
  return (
    <div className="upcoming-content flex flex-col bg-black border-t-2 border-zinc-900 text-white font-normal items-center h-fit pb-10">
      <div className="upcoming mt-16 w-9/12 flex flex-col self-center border-0">
        <h2 className="text-2xl">Upcoming Animes</h2>
        ...
        {isLoading === true ? (
          ...
          <div className="upcoming-components flex flex-wrap gap-x-10 gap-y-11  items-center justify-center">
            {upcomingAnimes.map((anime) => (
              ...
              >
                <div
                  className="anime-cards flex flex-col justify-center"
                  key={anime.mal_id}
                >
                  <img
