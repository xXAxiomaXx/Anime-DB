...
const Top = () => {
  ...
  return (
    <div className="top flex flex-col bg-black border-t-2 border-zinc-900 text-white w-screen font-normal items-center h-fit pb-10">
      <div className="components mt-16 w-9/12 flex flex-col self-center border-0">
        <h2 className="text-2xl">Top Animes</h2>
            ...
            {topAnimes.map((anime) => (
              ...
              >
                <div className="anime-cards" key={anime.mal_id}>
                  ...
                  <div className="info">
                    <p className="year text-base font-normal leading-5 opacity-70 text-[#a816e2]">
                      {anime.year}
                    </p>
                    <p className="score text-base font-normal leading-5 opacity-70 text-[#04ABCA]">
                      Score:{" "}
                      <span className="text-white text-lg">{anime.score}</span>{" "}
                      /10
                    </p>
                  </div>
                </div>
